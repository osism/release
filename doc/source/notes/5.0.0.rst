...
* The testbed has now an integrated proxy which is used by all docker daemons to pull their images
  only from allowed domains. The proxy (in this case squid) is a container itself and needs to be
