...
* Monasca was deprecated in Kolla. In preparation for the introduction of Monasca in OSISM
  ...
  by Monasca have already been built as images: Storm + Zookeeper. These images were removed
  without prior deprecation as they were only available for the planned Monasca integration
  and are not yet in use anywhere.
